...
\textbf{Due:} March 27, 2026 @ 23:59\\
	...
	\begin{enumerate}
        ...
        \solution We just found it in the Corollary! Observe given the primitive Pythagorean triples constructed with the same $u,v$ $(2uv, u^2 - v^2, u^2 + v^2)$ and $(v, u^2 - v^2, u)$ that the following inequality exists between their areas: 
